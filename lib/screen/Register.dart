...
import 'package:onlineshop/screen/Register.dart';
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    if (email.text != "" && name.text != "" && lname.text != "" && password != "") {
                       ...
                       var statuRegister = manager.register(name: name.text, lname: lname.text, 
                       email: email.text, password: password.text, context: context);
                      
                    } else {
                       snackBar = SnackBar(
                        content: const Text('กรอกข้อมูลให้ครบก่อนนะน้องนะ'),
                      );
